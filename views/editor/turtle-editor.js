...
-------------------------------------------------------
    ...
    var loadFromGitHub = function() {
      ...
      if (state.fileIsLoaded) {
        ...
        // TODO:
        // the next call is redundant: branch already contains list of 
files,
    ...
    var storeToGitHub = function() {
      ...
      if (message) {
        ...
        alert(
          "Please, fill-in the commit message box, it cannot be 
empty..."
        );
      }
...
-------------------------------------------------
    ...
    var displayCurrentFilename = function(filename) {
      var baseUri = 
"http://vowl.visualdataweb.org/webvowl/index.html#iri=https://raw.githubusercontent.com/";
      var ownername = inputElements.owner.val().trim();
      var reponame = inputElements.repo.val().trim();
      var branchname = inputElements.branch.val().trim();
...
"/" +
        reponame + "/");
      var sparqlProcessorURI = 
"../SparqlProcessor/sparql-processor.html";
...
-------------------------------------------------------------
    ...
    var parserHandler = function(error, triple, prefixes) {
      if (error) {
        ...
        /* extract line Number, only consider the end of the string 
after "line" */
...
////////////////////////////////////////////////////////////////////////////
        ...
        // var editor = 
CodeMirror.fromTextArea(document.getElementById('input-contents'), {
        //   mode: "mymode",
        //   lineNumbers: true
        // });
...
//////////////////////////////////////////////////////////////////////////////
        ...
        editor.setGutterMarker(errorLineNumber, "breakpoints", 
makeMarker(
          error.message));
        ...
        var predicateSplit = 
splitIntoNamespaceAndName(triple.predicate);
        var objectSplit = splitIntoNamespaceAndName(triple.object);

        dynamicNames[subjectSplit.namespace] = 
dynamicNames[subjectSplit.namespace] || {};
        ...
        dynamicNames[predicateSplit.namespace][predicateSplit.name] = 
true;

        dynamicNames[objectSplit.namespace] = 
dynamicNames[objectSplit.namespace] || {};
